...
import { FiMail, FiLock, FiLayers, FiArrowRight } from "react-icons/fi";
    ...
    <div className="min-h-screen bg-surface bg-grid-pattern bg-grid flex items-center justify-center px-4">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        <div className="glass-card p-8">
          <h1 className="text-xl font-display font-semibold text-slate-50">Welcome back</h1>
          <p className="text-sm text-slate-400 mt-1">Sign in to access your exploration dashboard.</p>
